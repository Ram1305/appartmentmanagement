...
securitySchema.methods.comparePassword = async function (enteredPassword) {
  return await bcrypt.compare(enteredPassword, this.password);
};

// Generate OTP
securitySchema.methods.generateOTP = function () {
...
// Verify OTP
securitySchema.methods.verifyOTP = function (enteredOTP) {
